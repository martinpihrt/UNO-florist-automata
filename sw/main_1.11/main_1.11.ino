 ...
 * verze 1.11
   přidaná podpora pro více jazyků neni zatim hotove
 */

char verze[]="01.03.19-V1.11"; // Verze programu
...
const char msg_en_ZAP[]        PROGMEM ="ON";                 // pouzito v menu 9, 10
const char msg_en_dvojtecka[]  PROGMEM =":";                  // pouzito v menu 1, 3, 5
const char msg_en_rovnase[]    PROGMEM ="=";
const char msg_en_procenta[]   PROGMEM ="%";
const char msg_en_volt[]       PROGMEM ="V";
const char msg_en_Hz[]         PROGMEM ="Hz";
const char msg_en_kHz[]        PROGMEM ="kHz";
const char msg_en_err_cidla[]  PROGMEM ="Error probe";
const char msg_en_AD_range[]   PROGMEM ="0-1023";
const char msg_en_tecka[]      PROGMEM =".";
const char msg_en_zavL[]       PROGMEM ="[";
const char msg_en_zavP[]       PROGMEM ="]";
const char msg_en_otaznik[]    PROGMEM ="?";
const char msg_en_minus[]      PROGMEM ="-";
const char msg_en_lomitko[]    PROGMEM ="/";
const char msg_en_ANO[]        PROGMEM ="YES";
const char msg_en_NE[]         PROGMEM ="No";
const char msg_en_po[]         PROGMEM ="Mo";
const char msg_en_ut[]         PROGMEM ="Tu";
const char msg_en_st[]         PROGMEM ="We";
const char msg_en_ct[]         PROGMEM ="Th";
const char msg_en_pa[]         PROGMEM ="Fr";
const char msg_en_so[]         PROGMEM ="Sa";
const char msg_en_ne[]         PROGMEM ="Su";
const char msg_en_dnes[]       PROGMEM ="Today is";
const char msg_en_pondeli[]    PROGMEM ="Monday";
const char msg_en_utery[]      PROGMEM ="Tuesday";
const char msg_en_streda[]     PROGMEM ="Wednesday";
const char msg_en_ctvrtek[]    PROGMEM ="Thursday";
const char msg_en_patek[]      PROGMEM ="Friday";
const char msg_en_sobota[]     PROGMEM ="Saturday";
const char msg_en_nedele[]     PROGMEM ="Sunday";
const char msg_en_hod_min[]    PROGMEM ="hour:min";
const char msg_en_sec[]        PROGMEM ="sec";
const char msg_en_interval_A[] PROGMEM ="5-250";
const char msg_en_interval_B[] PROGMEM ="0-250";
...
const char msg_en_chyba_dne[]  PROGMEM ="ERROR RTC!";
const char msg_en_cas[]        PROGMEM ="TIME";
const char msg_en_jedna[]      PROGMEM ="1";
const char msg_en_dva[]        PROGMEM ="2";
const char msg_en_tri[]        PROGMEM ="3";
const char msg_en_last_T[]     PROGMEM ="Last temperature";
const char msg_en_last_V[]     PROGMEM ="Last moisture";
const char msg_en_EE_del[]     PROGMEM ="EEPROM deleted";
const char msg_en_menu[]       PROGMEM ="MENU";
const char msg_en_dwn[]        PROGMEM ="DOWN";
const char msg_en_up[]         PROGMEM ="UP";
const char msg_en_left[]       PROGMEM ="LEFT";
const char msg_en_right[]      PROGMEM ="RIGHT";
const char msg_en_end[]        PROGMEM ="END";
const char msg_en_language[]   PROGMEM ="Language";
...
#define adr_language     18        // nastaveni jazyka 0=cz, 1=eng...        
...
void init_eeprom(){ // cteni z pameti eeprom a ulozeni defaultu pokud je nova eeprom v cpu prazdna
  ...
  if (language > 1 ) {edit = true;write_eeprom_byte(adr_language, 0);}                               // vychozi jazyk je cestina
...
void init_read(){ // nacteni z eeprom po zapnuti zarizeni
  ...
  language = read_eeprom_byte(adr_language);
#ifdef DEBUG
...
void save_eeprom() { // ulozi z lcd menu hodnoty
  ...
  write_eeprom_byte(adr_language, language);
#ifdef DEBUG
...
void firmware(){ // vypise reklamu a verzi fw na serial a lcd
  ...
  Serial.println(F("**********************"));
  Serial.print(F("Volna RAM pamet:")); Serial.println(freeRam());
#endif
  delay(2000);
} // end void
...
int freeRam() { // vraci velikost volne RAM
